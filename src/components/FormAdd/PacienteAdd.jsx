        ...
        <div>
            <form className="w-full max-w-lg">
                <div className="flex flex-wrap -mx-3 mb-6">
                    {showTitle && (
                        <div className='my-8'>
                            <h1 className='text-red-700 font-bold text-center text-2xl'>Adicionar Paciente</h1>
                        </div>   
                    )}
                    {!showTitle && (
                        <div className='my-8'>
                            <h1 className='text-red-700 font-bold text-center text-2xl'>Editar Paciente</h1>
                        </div>   
                    )}
